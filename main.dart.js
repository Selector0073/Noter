...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var i, newDiv, t3, t4, newDelete, list,
        t1 = document,
        form = type$.FormElement._as(t1.querySelector("#AddNote")),
        BoxOutput = type$.DivElement._as(t1.querySelector("#notes")),
        t2 = type$.MappedIterable_String_String,
        noteValues = A.List_List$_of(new A.MappedIterable(new A.WhereIterable(A._setArrayType(t1.cookie.split("; "), type$.JSArray_String), type$.bool_Function_String._as(new A.main_closure()), type$.WhereIterable_String), type$.String_Function_String._as(new A.main_closure0()), t2), t2._eval$1("Iterable.E"));
      for (i = 0; i <= noteValues.length; ++i) {
        t2 = t1.createElement("hr");
        t2.toString;
        newDiv = t1.createElement("div");
        newDiv.id = "note";
        t3 = "note" + i;
        newDiv.id = t3;
        ...
        if (!(i < noteValues.length))
          return A.ioore(noteValues, i);
        B.ParagraphElement_methods.set$text(t4, noteValues[i]);
        newDelete = t1.createElement("button");
        list = newDelete.classList;
        list.contains("fx-strobe").toString;
        list.add("fx-strobe");
        B.ButtonElement_methods.set$text(newDelete, "DELETE");
        newDelete.id = t3;
        BoxOutput.appendChild(newDiv).toString;
        newDiv.appendChild(t4).toString;
        newDiv.appendChild(newDelete).toString;
        BoxOutput.appendChild(t2).toString;
      }
      t1 = type$._ElementEventStreamImpl_Event;
      A._EventStreamSubscription$(form, "submit", t1._eval$1("~(1)?")._as(new A.main_closure1(noteValues, form)), false, t1._precomputed1);
    },
  ...
  A.WhereIterator.prototype = {
    moveNext$0() {
      ...
      for (t1 = this._iterator, t2 = this._f, t3 = t1.$ti._precomputed1; t1.moveNext$0();) {
        t4 = t1._current;
        if (t2.call$1(t4 == null ? t3._as(t4) : t4))
          return true;
      }
      return false;
    },
  ...
  A.main_closure.prototype = {
    call$1(pair) {
      return B.JSString_methods.startsWith$1(A._asString(pair), "note");
    },
    $signature: 10
  };
  A.main_closure0.prototype = {
    call$1(pair) {
      var t1 = A._asString(pair).split("=");
      if (1 >= t1.length)
        return A.ioore(t1, 1);
      return t1[1];
    },
  ...
  A.main_closure1.prototype = {
    call$1($event) {
      var note,
        t1 = this.noteValues,
        cookieCount = t1.length;
      B.JSArray_methods.set$length(t1, cookieCount + 1);
      note = type$.TextAreaElement._as(this.form.querySelector("#Textarea"));
      t1 = document;
      t1.toString;
      B.HtmlDocument_methods.set$cookie(t1, "note" + cookieCount + "=" + A.S(note.value) + "; path=/;");
    },
    $signature: 4
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.DivElement, A.FormElement, A.ParagraphElement, A.SelectElement, A.TextAreaElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "~(Event)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "bool(String)", "String(String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","ShadowRoot":"Node","DocumentFragment":"Node","XmlDocument":"Document","CDataSection":"CharacterData","Text":"CharacterData","DomError":"JavaScriptObject","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JavaScriptObject":{"JSObject":[]},"LegacyJavaScriptObject":{"JSObject":[]},"JSArray":{"List":["1"],"JSObject":[],"Iterable":["1"]},"JSArraySafeToStringHook":{"SafeToStringHook":[]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"JSObject":[],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Pattern":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"AsyncError":{"Error":[]},"_Future":{"Future":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"int":{"num":[]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Event":{"JSObject":[]},"HtmlElement":{"Element":[],"EventTarget":[],"JSObject":[]},"AnchorElement":{"Element":[],"EventTarget":[],"JSObject":[]},"AreaElement":{"Element":[],"EventTarget":[],"JSObject":[]},"ButtonElement":{"Element":[],"EventTarget":[],"JSObject":[]},"CharacterData":{"EventTarget":[],"JSObject":[]},"DivElement":{"Element":[],"EventTarget":[],"JSObject":[]},"Document":{"EventTarget":[],"JSObject":[]},"DomException":{"JSObject":[]},"DomTokenList":{"JSObject":[]},"Element":{"EventTarget":[],"JSObject":[]},"EventTarget":{"JSObject":[]},"FormElement":{"Element":[],"EventTarget":[],"JSObject":[]},"HtmlDocument":{"EventTarget":[],"JSObject":[]},"Node":{"EventTarget":[],"JSObject":[]},"ParagraphElement":{"Element":[],"EventTarget":[],"JSObject":[]},"SelectElement":{"Element":[],"EventTarget":[],"JSObject":[]},"TextAreaElement":{"Element":[],"EventTarget":[],"JSObject":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]}}'));
  var string$ = {
